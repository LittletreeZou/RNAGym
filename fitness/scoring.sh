...
#     --output_folder ${WORK_DIR}/fitness_prediction/merged_files_tmp

# STEP 2
python performance_fitness.py \
    --reference_file /${WORK_DIR}/fitness/reference_sheet_final.csv \
    --combined_dir ${WORK_DIR}/fitness_prediction/merged_files_tmp \
    --performance_dir ${WORK_DIR}/fitness_prediction/performance_tmp
